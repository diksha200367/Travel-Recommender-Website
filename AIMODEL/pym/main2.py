...
db = client['Cities2']
collection = db['mySampleCollectionForCities2']


# Path to the Excel file
excel_file = "D:\\GHUMAKKAD_DATA_DESC.xlsx"
...
for row in sheet.iter_rows(min_row=2, values_only=True):
    city, state, tourist_spot, attraction_type, address, pincode, description = row
    ...
    if  city:
        ...
        # Append destination details to the city's destinstions list
